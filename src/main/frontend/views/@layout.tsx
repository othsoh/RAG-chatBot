        ...
        <nav className="relative px-4 py-4 flex justify-between items-center bg-white">
            <NavLink className="text-3xl font-bold leading-none"to="/">
                <div className="flex justify-center items-center gap-2">
                    <img className="h-12" src="https://static.thenounproject.com/png/6056251-512.png" alt="logo"/>
                    <p className="text-2xl font-bold leading-none">Ollama3.2</p>
                </div>
            ...
            <ul className="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:items-center lg:w-auto lg:space-x-6">
                <li>
                    <NavLink
                        className={({isActive}) =>
                            isActive ? "text-sm text-black font-bold" : "text-sm text-gray-400 hover:text-gray-500"
                        }
                        to="/"
                    >
                        Home
            ...
            <a className="hidden lg:inline-block lg:ml-auto lg:mr-3 py-2 px-6 bg-gray-50 hover:bg-gray-100 text-sm text-gray-900 font-bold  rounded-xl transition duration-200"
               href="#">Sign In</a>
            <a className="hidden lg:inline-block py-2 px-6 bg-gray-800 hover:bg-black text-sm text-white font-bold rounded-xl transition duration-200"
               href="#">Sign up</a>
        </nav>
                ...
                <div className="mt-auto">
                    <div className="pt-6">
                        <a className="block px-4 py-3 mb-3 leading-loose text-xs text-center font-semibold bg-gray-50 hover:bg-gray-100 rounded-xl"
                           href="#">Sign in</a>
                        <a className="block px-4 py-3 mb-2 leading-loose text-xs text-center text-white  bg-gray-500 hover:bg-gray-800  rounded-xl"
                           href="#">Sign Up</a>
                    </div>
